...
SECRET_KEY = 'django-insecure-hq8ujs5apnw8wj+05^a1u!^!wq1%ao=#*)0(qb2p*$wn7io4i)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'customadmin' / 'templates',  # Custom admin templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Set custom site headers 
ADMIN_SITE_HEADER = "VISHNU"
